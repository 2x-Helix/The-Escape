...
namespace ThreeEyedGames
{
    ...
    {
        private const string _deferredShaderName = "Decal/Deferred Decal (Decalicious FIT3169)";
        private const string _unlitShaderName = "Decal/Unlit Decal (Decalicious FIT3169)";
        ...
        [Tooltip("Enable to draw the Normal / Roughness channels of the Decal.")]
        public bool DrawNormalAndRoughness = true;

        [Tooltip("Enable perfect blending between decals. Costly and has no effect when decals don't overlap, so use with caution.")]
        ...
        void OnDrawGizmos()
        {
            ...
            Gizmos.DrawIcon(transform.position, "Projector Gizmo", true);
